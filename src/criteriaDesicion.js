...
function prometheeMethod() {
  ...
  var userConditionsLength = userLoginRegisterContractAddress.numCriteria.call();
  var i;
  var ind = 0;
  var stationInfo = [];
  for (i = 0; i < userConditionsLength; i++) {
    var resultCurrentUser = userLoginRegisterContractAddress.getSelectedUserInformation(userID,ind);
  ...
  var stationInfo = [];
  for (i = 0; i < length; i++) {
    var resultMatch = userLoginRegisterContractAddress.getMatchUsers(resultCurrentUser[0], resultCurrentUser[1], resultCurrentUser[2], resultCurrentUser[3], index);//Smart contract function. Find the next Grid operator. 
