...
var state=true;
var gasUsed = SContract.addOffer.estimateGas(username[1], selectedOfferPrice, 2, selectedOfferprofitRate,state,0,0,0, { from: web3.eth.accounts[0], gas: 3000000 });
...
function gridSetPrice(i) {
    ...
    SContract.addOffer(username[1], selectedOfferPrice, 2, selectedOfferprofitRate,state,0,0,0, { from: web3.eth.accounts[0], gas: 3000000 });
    getUserBalanceInfo();
    getTransactionCount();
    getMyOfferHistory();
}
