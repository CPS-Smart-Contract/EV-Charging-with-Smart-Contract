...
//Contract defination of smart deployed contract with its addres
var userLoginRegisterContractAddress = userLoginRegister.at('0xdbfe19980db15e43bf40e3a6581d6f3b7b39d488');
*/
...
function getTransactionCount() {
    var numberOfOffers = electricVehicleChargingEnergyTradeSystemContractAddress.getCurrentUserTransactionLength(username[1], 2);
...
function gridSetPrice(i) {
    ...
    electricVehicleChargingEnergyTradeSystemContractAddress.addOffer(username[1], selectedOfferPrice,  selectedOfferprofitRate,2,state,0,0,0, { from: web3.eth.accounts[0], gas: 3000000 });
    getUserBalanceInfo();
    getTransactionCount();
    getMyOfferHistory();
}
