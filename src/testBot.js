...
for (let index = 0; index <1; index++) {
	...
	for (let k = 1; k < 11; k++) {
		...
		energyTradingSystemContract.addOffer("EnergyProducerBot" + k, price, 0, 0, true,0,"",0, { from: web3.eth.accounts[0], gas: 3000000 });
	...
	for (let k = 1; k < 11; k++) {
		...
		energyTradingSystemContract.addOffer("EnergyGridOperatorBot" + k, minEnergyProducerOffer[1], 1, profitRate, true,0," ",0, { from: web3.eth.accounts[0], gas: 3000000 });
	...
	for (let k = 1; k < 11; k++) {
		var profitRate = Math.floor(Math.random() * 45) + 5; // Random profit rate generating.
		energyTradingSystemContract.addOffer("EnergyTraderBot" + k, minEnergyGridOperatorOffer[1], 2, profitRate, true,0," ",0, { from: web3.eth.accounts[0], gas: 3000000 });
	...
	for (let k = 1; k < 11; k++) {
		var profitRate = Math.floor(Math.random() * 45) + 5; // Random profit rate generating.
		energyTradingSystemContract.addOffer("EnergyStationBot" + k, minEnergyTraderOffer[1], 3, profitRate, true,0," ",0, { from: web3.eth.accounts[0], gas: 3000000 });
