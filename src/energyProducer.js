...
var gasUsed = SContract.addOffer.estimateGas(username[1], $("#log-producerPrice").val(), 0, 0, state,0,0,0, { from: userWalletAddress, gas: 3000000 });
...
$("#button").click(function () {//Button click event
	...
	SContract.addOffer(username[1], $("#log-producerPrice").val(), 0, 0, state,0,0,0, { from: web3.eth.accounts[0], gas: 3000000 });
	getUserBalanceInfo();
	getTransactionCount();
	getMyOfferHistory();
	getEnteredUserSales();
